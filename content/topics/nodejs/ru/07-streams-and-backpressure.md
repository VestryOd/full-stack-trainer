...
```ts
// ✅ Передаёт данные частями (~64KB с Node.js 22)
...
По умолчанию: 64 KB для бинарных потоков начиная с Node.js 22,
до этого 16 KB. Для object mode — 16 (считаются объекты,
