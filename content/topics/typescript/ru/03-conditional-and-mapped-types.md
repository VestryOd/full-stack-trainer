...
- **Написать `as const` вместо `as const satisfies`** — это разные инструменты с разными гарантиями (см. [Вариантность и type assertions](./07-variance-and-assertions.md)).
