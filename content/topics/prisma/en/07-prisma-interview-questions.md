...
- `connection_limit` — the maximum number of connections. Up to Prisma 6 the default is `num_physical_cpus * 2 + 1`. From Prisma 7 the driver adapter sets it, and 10 is the usual value.
